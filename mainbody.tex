...
%
\titlerunning{Lattice Attack against the wNAF Implementation of ECDSA}
...
We implemented the Flush+Flush method as the cache side channel attack and applied it to ECDSA with the secp256k1 curve in OpenSSL 1.1.1b.
