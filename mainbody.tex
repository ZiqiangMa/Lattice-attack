...
Our method recovers the private key 
            by extracting more information from side channels,
...
The ``double-add-invert'' chain obtained from the cache side channels,
    is disposed to extract more bits of the ephemeral key at the position of the non-zero digits.
In theory $153.2$ bits of the ephemeral key will be extracted per signature
    for 256-bit ECDSA over elliptic curves on a prime field.
Then,
