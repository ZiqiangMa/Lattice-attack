...
For attacks in the same machine, the spy can map the victim program file, the victim data file or shared libraries to its own address space to share these pages with the victim.
