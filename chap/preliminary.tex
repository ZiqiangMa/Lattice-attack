...
From the algorithm, we can find that the \textbf{if-then} block (Line 4) is vulnerable to side channel attacks.
...
While in the visualization environments, the page de-duplication technique of the VMM ensures the page sharing between the spy and the victim.
%监控LLC，需要写一下
...
Here we provide a briefly introduce.
