...
Cache side-channel attacks is first proposed in 2002, which take advantage of the characteristic of cache activity
...
For the symmetric cryptography, 
 Page~\cite{Page2002} first described a theoretical cache side channel attack on the collection of cache profiles for a large amount of chosen plaintexts in 2002.
Then
Tsunoo et al. \cite{Tsunoo2003Cryptanalysis} and Bernstein \cite{Bernstein2005Cache} proposed the first practical implementation of the cache attack on the DES and AES cryptographic algorithm, respectively.
...
We introduce two typical access-driven attacks called Flush+Reload \cite{flushreload} and Flush+Flush \cite{gruss2016flush}
