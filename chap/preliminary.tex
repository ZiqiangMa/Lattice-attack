...
Also, the hidden number problem and its corresponding lattice attack are introduced
 for disposing of the data obtained from cache side channels.
...
If some signatures use the same $k$, or the random number generator in use is predictable, attackers can obtain the private key directly.
