...
After converting $k$ to the wNAF form, the multiplication $kG$ is executed as Algorithm \ref{alg:kg} describes.
...
The attacker can use these information to recover the private key.
