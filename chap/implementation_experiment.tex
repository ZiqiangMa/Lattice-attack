...
However, when using 80 signatures that satisfy $l \geq 9$, the total number of signatures needed is the least, just $247.45$.
...
\begin{tabular}{|c|m{120pt}|c|c|c|}
  ...
  \hline
  \multirow{2}{1.1in}{\centering Ours}&\multirow{2}{120pt}{all positions and signs of non-zero digits} & HNP & 154.2  & $\leq$ 60 \\ %
    \cline{3-5}
  ~& ~& EHNP & 154.2  & 2  \\
%  \hline
%  190 & 39.3 & 63.5 & & \\
