...
As shown in the table, we successfully retrieve the private key of a 256-bit ECDSA only need $60$ sequences of consecutive bits with the success probability being $3.0\%$.
...
In summary, our method exploit the signs and the positions of the ephemeral key $k$ achieved from the Flush+Flush attack.
