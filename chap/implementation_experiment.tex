...
Although we exploit the sign information of the wNAF representation, the result is not good, worse than Allan's attack~\cite{Allan2016}, which only needs 6 signatures.
