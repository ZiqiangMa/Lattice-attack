...
However, in actual implementation, the ephemeral key and the scalar multiplication need careful protection.
...
%
Howgrave-Graham and Smart \cite{HG2001} theoretically showed that DSA was vulnerable to such partial ephemeral key exposures in 2001.
...
Finally, we construct an HNP \cite{boneh1996} instance making use of the consecutive bits of the ephemeral key.
