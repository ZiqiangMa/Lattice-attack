...
\begin{itemize}
  ...
  representation.  That is,  we translate the problem of ECDSA private key recovery to the HNP and ENHP respectively.
  Moreover, the attack based on EHNP works better than all known works.
