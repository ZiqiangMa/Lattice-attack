...
In these attacks~\cite{Benger2014,Van2015,Fan2016,Wang2017}, the attackers get a Double-Add chain from the side channel,  extract and exploit the different information of the ephemeral key from this chain to construct an instance of HNP or EHNP for the lattice attack.
In details,	Benger et al. \cite{Benger2014} extracted the LSBs of the ephemeral keys from the chain and constructed an HNP instance to recover the ECDSA private key from about 200 signatures.
