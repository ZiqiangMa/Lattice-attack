...
Then,
	by constructing a HNP instance solved by the lattice reduction algorithm, they recovered the ECDSA private key from about 200 signatures.
...
To some degree,
They just attempted to make more use of the data achieved through the side channels and construct more effective lattice attacks
...
Finally we use the multiple consecutive bits to construct the HNP instance.
